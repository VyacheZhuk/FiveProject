...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	TrainingInfoMessage := InfoMessage{
		TrainingType: t.TrainingType, // тип тренировки
		Duration:     t.Duration,     // длительность тренировки
		Distance:     t.distance(),   // расстояние, которое преодолел пользователь
		Speed:        t.meanSpeed(),  // средняя скорость, с которой двигался пользователь
		Calories:     t.Calories(),
	}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	TrainingInfoMessage := r.Training.TrainingInfo()
	return TrainingInfoMessage
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	TrainingInfoMessage := w.Training.TrainingInfo()
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	TrainingInfoMessage := s.Training.TrainingInfo()
	TrainingInfoMessage.Speed = s.meanSpeed()
	TrainingInfoMessage.Distance = TrainingInfoMessage.Speed * s.Duration.Hours()
	return TrainingInfoMessage
}
